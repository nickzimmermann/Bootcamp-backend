...
/*
// ... Backend Exercise 1 ...
// (1) Create a route for 'contact'. Send an HTML document with 'Contact Us' in the body.
server.get(
...
// (2) Create a route for 'terms-and-conditions'. Send an HTML document with 'Terms & Conditions' in the body.
server.get(
    '/terms',               // http://localhost:3001/terms
    (req, res) => { 
        res.send("<html><head><title>Terms and Conditions</title></head><body><h1>Terms and Conditions</h1></body></html>") 
    }
);
*/
